...
const CACHE = 'cinerea-v5';
const SHELL = ['./', './index.html', './styles.css', './app.js', './core.js', './catalogo.html', './config.js', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png'];
